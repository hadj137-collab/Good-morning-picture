...
# 【修正完畢】補齊 try...except 語法，確保計算字體寬度絕不崩潰
...
if uploaded_file is not None:
    ...
    if st.button("🚀 開始製作早安圖", type="primary"):
        with st.spinner("智慧分析畫面並排版中..."):
            ...
            # 智慧動態處理下載檔名：原照片主檔名 + _1 + 原副檔名
            orig_name, orig_ext = os.path.splitext(uploaded_file.name)
            new_file_name = f"{orig_name}_1{orig_ext}"
